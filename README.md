...
Browse three cheatsheets generated by the skill — fully interactive, no install needed:

| Cheatsheet                                                                                       | What it covers                                                                  |
| ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [postgres-setup](https://rich107.github.io/interactive-cheatsheet/postgres-setup.html)           | Create a database, schema, and table via `psql` + `createdb`                    |
| [kubectl-pod-debugging](https://rich107.github.io/interactive-cheatsheet/kubectl-pod-debugging.html) | Inspect, log, exec, copy files, and port-forward pods                       |
| [ffmpeg-transcoding](https://rich107.github.io/interactive-cheatsheet/ffmpeg-transcoding.html)   | Transcode, trim, extract audio, scale, concat, and turn videos into GIFs        |

Or jump into the [demo landing page](https://rich107.github.io/interactive-cheatsheet/).
