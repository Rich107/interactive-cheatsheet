...
Twelve cheatsheets generated by the skill itself — fully interactive, no install needed. Start at the [demo landing page](https://rich107.github.io/interactive-cheatsheet/) or jump straight in:

| Cheatsheet                                                                                           | Domain               | What it covers                                                                  |
| ---------------------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------------------------------------- |
| [postgres-setup](https://rich107.github.io/interactive-cheatsheet/postgres-setup.html)               | Databases            | Create a Postgres database, schema, and table — psql + createdb                 |
| [docker-daily-driver](https://rich107.github.io/interactive-cheatsheet/docker-daily-driver.html)     | Containers           | Build, run, exec, log, prune — Docker for daily use                             |
| [kubectl-pod-debugging](https://rich107.github.io/interactive-cheatsheet/kubectl-pod-debugging.html) | Kubernetes           | Inspect, log, exec, copy files, port-forward pods                               |
| [aws-s3](https://rich107.github.io/interactive-cheatsheet/aws-s3.html)                               | Cloud                | List, copy, sync, presign, manage buckets and objects                           |
| [git-rescue](https://rich107.github.io/interactive-cheatsheet/git-rescue.html)                       | Version control      | Undo, recover, cherry-pick, bisect, force-push back                             |
| [ssh-connections](https://rich107.github.io/interactive-cheatsheet/ssh-connections.html)             | SSH                  | Keys, port forwarding, SOCKS, jump hosts, file transfer, config                 |
| [curl-recipes](https://rich107.github.io/interactive-cheatsheet/curl-recipes.html)                   | HTTP                 | Auth, multipart, retries, downloads, timing                                     |
| [openssl-certs](https://rich107.github.io/interactive-cheatsheet/openssl-certs.html)                 | TLS / certificates   | Generate keys + CSRs, self-sign, inspect, convert, probe endpoints              |
| [ffmpeg-transcoding](https://rich107.github.io/interactive-cheatsheet/ffmpeg-transcoding.html)       | Media                | Transcode, trim, extract audio, scale, concat, GIFs                             |
| [jq-recipes](https://rich107.github.io/interactive-cheatsheet/jq-recipes.html)                       | JSON / shell         | Pick, filter, map, group_by, recursive descent                                  |
| [tmux-quickref](https://rich107.github.io/interactive-cheatsheet/tmux-quickref.html)                 | Local dev            | Sessions, windows, panes, copy mode, scripting                                  |
| [neovim-open-files](https://rich107.github.io/interactive-cheatsheet/neovim-open-files.html)         | Editor               | Every useful way to open files — splits, tabs, jumps, diffing against git revs  |

## Examples (how you'd ask)
